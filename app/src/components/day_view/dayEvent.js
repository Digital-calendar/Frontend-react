...
class DayEvent extends Component {
    ...
    getMarks = (event) => {
        ...
        if (event.privateEvent) {
            ...
            switch (event.eventType) {
                case "INTERNAL":
                    view = (
                        <div className="window__mainWindow__content__eventMark internalEvent_border_color">Internal event</div>
                    );
                    break;
                case "EXTERNAL":
                    view = (
                ...
                case "CORRESPONDENCE":
                    view = (
                        <div className="window__mainWindow__content__eventMark correspondenceEvent_border_color">Correspondence event</div>
                    );
                    break;
                default:
                    view = null
    ...
    // componentDidMount() {
    //     selectModel.dateToShowInDay = monthModel.currentDay
    // }

    render() {
        return(

            eventModel.getDayEvents(parseInt(this.state.date.toString().slice(8, 10))).map((event, index) => {
                ...
                return <div key={index} className="window__main">
                    ...
                    <div className="window__mainWindow__content">
                        ...
                        <div className="window__mainWindow__content__info">
                            <img src={require("../../css/images/timePin.svg")} alt="timePin" className="timePin"/> {event.timestamp}
                        </div>
                        <div className="window__mainWindow__content__info">
                            <img src={require("../../css/images/locationPin.svg")}  alt="locationPin" className="locationPin"/>
                            {event.location}
                        </div>
                        <div className="window__mainWindow__content__info">
                            <img src={require("../../css/images/emailPin.svg")}  alt="emailPin" className="emailPin"/>
                            {event.contactInfo} ,
                            {event.contactName}
                        </div>
